...
class ControllerApiFeaturedProduct extends AControllerAPI
{
    ...
    public function get()
    {
        ...
        $product_info = $this->model_catalog_product->getFeaturedProducts($limit);
        if (count($product_info) <= 0) {
            $this->rest->setResponseData(array('Error' => 'No Featured product found'));
            $this->rest->sendResponse(200);
            return null;
        }
