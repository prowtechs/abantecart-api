...
class ControllerApiProductFeatured extends AControllerAPI
{
    ...
    public function get()
    {
        ...
        $results = $this->model_catalog_product->getFeaturedProducts($filters['limit']);

        $response = new stdClass();
        $response->message = 'Featured Data retrieved successfully';
